...
if (isset($_POST['trabajador'])) {
    ...
    /*$sql = "SELECT numero_trabajador FROM profesores WHERE numero_trabajador = '" . $num_trabajador ."'";
    ...
    if($resultado_query) {
        ...
        if ($fila) {
            ...
            $sql2 = "INSERT INTO profesores (nombre, numero_trabajador, contrasena) 
                VALUES ('" . $nombre_profe . "', '" . $num_trabajador . "', '" . $contrasena_generada . "')";
            
            $query2 = msqli_query($conexion, $sql2);
            if ($query2) {
                $numero_trabajador_creado = $num_trabajador;
                $estado ='exito';
            } else {
