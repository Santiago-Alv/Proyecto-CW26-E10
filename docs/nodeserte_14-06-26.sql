...
--
-- Host: localhost    Database: nodeserte
-- ------------------------------------------------------
...
CREATE TABLE `administrador` (
  ...
  `apell_pat_admin` varchar(30) DEFAULT NULL,
...
CREATE TABLE `alumno` (
  ...
  `apell_pat_alum` varchar(100) DEFAULT NULL,
  ...
  UNIQUE KEY `nocta_2` (`nocta`),
  UNIQUE KEY `nocta_3` (`nocta`),
...
CREATE TABLE `duda` (
  ...
  CONSTRAINT `duda_ibfk_3` FOREIGN KEY (`id_modulo`) REFERENCES `modulo` (`id_modulo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `grupo` VALUES (1,'61B',3,3),(2,'61D',4,3),(3,'61A',3,1);
...
INSERT INTO `modulo` VALUES (1,'SISTEMAS OPERATIVOS'),(2,'PROGRAMACIÓN ESTRUCTURADA'),(3,'INTRODUCCIÓN A LA COMPUTACIÓN');
...
CREATE TABLE `profesor` (
  ...
  `apell_pat_prof` varchar(30) DEFAULT NULL,
...
CREATE TABLE `recurso` (
  ...
  `url_recurso` varchar(200) DEFAULT NULL,
  ...
  KEY `id_grupo` (`id_grupo`),
  KEY `id_modulo` (`id_modulo`),
  CONSTRAINT `recurso_ibfk_1` FOREIGN KEY (`id_grupo`) REFERENCES `grupo` (`id_grupo`),
  CONSTRAINT `recurso_ibfk_2` FOREIGN KEY (`id_modulo`) REFERENCES `modulo` (`id_modulo`)
...
INSERT INTO `recurso` VALUES (3,'REcurso1','Jijija','https://github.com/','imagenrecurso_3.jpeg',1,3),(4,'Coñon','jijija','https://github.com/','imagenrecurso_4.jpg',1,2),(7,'Coñon','jijija','https://github.com/','imagenrecurso_7.jpg',1,2),(8,'Coñon','jijija','https://github.com/','imagenrecurso_8.jpg',1,2),(9,'Coñon','jijija','https://github.com/','imagenrecurso_9.jpg',1,2),(10,'Coñon','jijija','https://github.com/','imagenrecurso_10.jpg',1,2),(11,'Coñon','jijija','https://github.com/','imagenrecurso_11.jpg',1,2);
...
-- Dump completed on 2026-06-14  1:11:35
